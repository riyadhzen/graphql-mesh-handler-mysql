...
import { GraphQLBigInt, GraphQLDateTime, GraphQLJSON, GraphQLDate, GraphQLTimestamp, GraphQLTime, GraphQLUnsignedInt, GraphQLUnsignedFloat, } from 'graphql-scalars';
        ...
        await Promise.all(tableNames.map(async (tableName) => {
            ...
            schemaComposer.Mutation.addFields({
                ...
                [`delete_${tableName}`]: {
                    ...
                    resolve: (root, args, { mysqlConnection }) => mysqlConnection.deleteRow(tableName, args.where).then(result => !!(result === null || result === void 0 ? void 0 : result.affectedRows)),
                },
            });
        }));
